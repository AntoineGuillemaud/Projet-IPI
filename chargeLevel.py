...
def ChargeLevelIntoRAM(sprites,scrollBackgroundList,Behaviors):
     ...
     "enemySummonList_level" : {
        ...
        139:{"type":"weak","pos_x":35,"behavior":Behaviors["behavior_left_right_4t"],"behavior_param":{"last_move":float(0.0),"speed":2.5,"move_state":2},"cooldown":4,"color":2 , "state":"waiting"},
        901:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
        910:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
        901:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
        910:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
        910:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
        901:{"type":"weak","pos_x":27,"behavior":Behaviors["stay_still"],"behavior_param":dict(default_behavior_param),"cooldown":4,"color":2 , "state":"waiting"},
    ...
    "obstacleSummonList_level":{
        ...
        1140:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
        1104:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
        1140:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
        1140:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
        1104:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
        1104:{"pos_x":4,"sprite":sprites["obstacle_asteroid_5"],"color":6, "state":"waiting"},
