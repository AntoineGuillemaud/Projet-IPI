...
def curseurChangeColor():
    ...
    hud = hudLib.HUDChangeColor(hud,codex[0],1)
    hud = hudLib.HUDChangeColor(hud,codex[1],1)
    hud = hudLib.HUDChangeColor(hud,codex[2],1)
    hud = hudLib.HUDChangeColor(hud,codex[3],1)

    hud = hudLib.HUDChangeColor(hud,codex[curseur],6)
    return
